...
public class AddPostTestUi {
    ...
    public void addPostTestUi() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.text_toolbar_done), withText("DONE"),
                        childAtPosition(
